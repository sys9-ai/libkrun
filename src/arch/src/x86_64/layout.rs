...
/// Last usable IOAPIC pin. Both KVM's in-kernel irqchip and our split
/// IOAPIC provide 24 pins, not just the legacy PIC's 16 IRQs. The MP table
/// must describe these additional pins before virtio-mmio can use them.
